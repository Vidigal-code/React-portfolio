export const LangES = {
  name: "Kauan Vidigal",
  functions:
    "Software developer | Full Stack | Java, Mysql, React js | Freelance",

  roles: ["Welcome!", "I'm a full-stack developer"],
  ...
  skillsAll: {
    ...
    desc:
      "Desde 2014, he dedicado mi tiempo a estudiar y mejorar en el campo del desarrollo Full-Stack. A lo largo de este viaje, he adquirido conocimientos que incluyen tecnologías más antiguas, que si bien pueden no ser tan predominantes en el mercado actual, me han brindado una base sólida.\n" +
      "\n" +
    ...
    info: [
      ...
      {
        subtitle: "Desarrollo de back-end:",
        skills: [
          {
            name: "Node.js",
            date: "5 años",
      ...
      {
        subtitle: "Entorno de trabajo remoto:",
        skills: [
          {
            name: "Anydesk",
            date: "4 años",
      ...
      {
        subtitle: "Gestión de dependencias:",
        skills: [
          {
            name: "Npm",
            date: "5 años",
    ...
    info: [
      {
        ...
        company: "",
        date: "Ene 2020 - actualmente - 3 años 11 meses",
        ...
        skillsFreeLancerTitle: "Servicios prestados:",
        skillsFreeLancer: [
          "Web development",
          "Technical support",
          "Network support",
  ...
  education: {
    ...
    desc:
      ...
      "\n" +
      "A continuación se detallan algunos de los cursos y certificaciones que he adquirido a lo largo de mi carrera profesional:",
    info: [
      {
        id: 0,
        ...
        CertificateTitle: "",
        CertificateImg: "",
        date: "mayo 2023 - febrero 2026",
        desc:
          "Mi nombre es Kauan Vidigal y estoy estudiando Informática. Desde pequeño siempre me ha fascinado el mundo de la tecnología y la informática. A medida que fui creciendo esta pasión se intensificó, lo que me llevó a elegir la Informática. como mi área de estudio y carrera.\n" +
          "\n" +
          "Una de las principales razones por las que me dediqué a esta área es su constante evolución e innovación. La tecnología cambia constantemente y la Informática me proporciona un entorno desafiante y estimulante para seguir el ritmo de estas transformaciones. Cada día surgen nuevas tecnologías y técnicas. , creando interesantes oportunidades para resolver problemas complejos y mejorar la vida de las personas.",
      ...
      },
  {
        ...
        date: "",
        description:
          "Este proyecto se desarrolló utilizando Vite, TypeScript, TSX y SCSS, y consiste en un sencillo editor de Markdown de GitHub. Fue creado como parte de un curso sobre el dio.me com o objetivo de testar e explorar a criatividade no desenvolvimento de aplicações web. Sinta-se à vontade para usar e adaptar conforme necessário. con el objetivo de probar y explorar la creatividad en el desarrollo de aplicaciones web. Siéntase libre de usarlo y adaptarlo según sea necesario.",
        image:
  ...
  about: {
    title: "About",
    desc: "Mi nombre es Kauan Vidigal, tengo 20 años y soy de SP/Brasil",
    linkheaderimg:
