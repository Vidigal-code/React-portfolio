...
import EducationInterface from './EducationDataInterface.tsx';
...
export const Button = styled.a<{ $isdarkmode: boolean }>`
...
const Curse = styled.div<{ $isdarkmode: boolean }>`
  font-size: 15px;
  font-style: italic;
  font-weight: 200;
  text-align: left;
...
const CurseCertificate = styled.div<{ $isdarkmode: boolean }>`
  font-size: 25px;
  font-weight: 500;
  margin: 4px;
  text-align: center;
    ...
    <Card>
      <Top>
        ...
        <Body>
          ...
          <Curse $isdarkmode={isDarkMode}>{education.curseMoment}</Curse>
      ...
      {education.gradetitle.length > 1 && (
        <Grade>
          <b>{education.gradetitle} </b>
          {education.gradevalue}
        </Grade>
      )}
      {education.desc.length > 1 && <Span>{education.desc}</Span>}
      {education.curseTitle.length > 1 && (
        <Button
          $isdarkmode={isDarkMode}
          target="_blank"
          href={education.curseLink}
        >
