...
const Skills = () => {
  ...
  const { isDarkMode } = useThemeLight();
    ...
    return (
        <Container id="skills">
            <Wrapper>
                <Title>{selectedBio?.nav.skills}</Title>
                <SubDesc>{selectedBio?.skillsAll.desc}</SubDesc>
                <Desc>{selectedBio?.skillsAll.title}</Desc>
                <SkillsContainer>
                    {selectedBio?.skillsAll.info.map((section) => (
